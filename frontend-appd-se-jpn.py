...
class WebService(ComponentResource):
    ...
    def __init__(self,
        ...
        self.cluster = aws.ecs.Cluster(name,
            ...
            container_definitions=json.dumps([
                {
                    ...
                    'environment': [
                        {'name': 'WORDPRESS_DB_HOST',     'value': f'{args[0]}:{args[1]}'},
                        {'name': 'WORDPRESS_DB_NAME',     'value': f'{args[2]}'},
                        {'name': 'WORDPRESS_DB_USER',     'value': f'{args[3]}'},
                        {'name': 'WORDPRESS_DB_PASSWORD', 'value': f'{args[4]}'},
                    ]
                },
                {
                    'name': 'db-agent',
                    ...
                    'environment': [
                        ...
                        {'name': 'APPDYNAMICS_CONTROLLER_HOST_NAME',     'value': 'sms-test.saas.appdynamics.com'},
                        {'name': 'APPDYNAMICS_CONTROLLER_PORT',          'value': '443'},
                        {'name': 'APPDYNAMICS_CONTROLLER_SSL_ENABLED',   'value': 'true'},
                        {'name': 'APPDYNAMICS_AGENT_ACCOUNT_NAME',       'value': 'sms-test'},
                        {'name': 'APPDYNAMICS_AGENT_ACCOUNT_ACCESS_KEY', 'value': 'lo7aeqm232kc'},
